...
multiple_obstacles, global_set_origin,obstacle_pause,global_two_obstacles, reverse_o,reset_origin):
  ...
  obstacle_msg.obstacles[0].id = 30
  obstacle_msg.obstacles[0].polygon.points = [Point32()]
  obstacle_msg.obstacles[0].polygon.points[0].x = 4.5
  ...
  # Add line 1 obstacle
  obstacle_msg.obstacles.append(ObstacleMsg())
  obstacle_msg.obstacles[1].id = 40
  line_start1 = Point32()
  line_start1.x = 0
  line_start1.y = 4.0
  line_end1 = Point32()
  ...
  # Add line 2 obstacle
  obstacle_msg.obstacles.append(ObstacleMsg())
  obstacle_msg.obstacles[2].id = 50
  line_start2 = Point32()
  line_start2.x = 0
  line_start2.y = -4.0
  line_end2 = Point32()
  ...
  while not rospy.is_shutdown():
    ...
    if (reverse_o == 0):
        if (reset_origin == 1):
            t1 = 0
        t3 = 0
        obstacle_msg.obstacles[0].polygon.points[0].x = 4.5 + t1
...
#            t2 = 0
    ...
    markerArray.markers.append( createAnimatedPersonMarker(0, pos=(x00,y00), thetaDeg=yaw0*180.0/math.pi + 180,  animationSpeed=0.3, color=(0.15, 0.9, 0.9)) )
