...
void agentsStatesCallback(const gazebo_msgs::ModelStatesConstPtr & msg){
    ...
    // add objects
    //double xobj = 2.8; double yobj = -0.82;
    //const Vector2 position1 = Vector2(xobj, yobj); const Vector2 goal1 = Vector2(xobj, yobj);const Vector2 vel1 = Vector2(0, 0);
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "compute_ref_velocity_using_hrvo_real_experiment");
    ros::NodeHandle nh;
