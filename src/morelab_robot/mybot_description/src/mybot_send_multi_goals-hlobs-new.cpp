...
double_t landmarks_pose[N_GOALS][3] = {{0.5,-0.5,-0.9849},{2.0,-3.0,0.01},{3.8,-5.5,-PI2},{3.0,-7.0,-3*PI4},{3.8,-5.5,PI2},{3.8,-4.0,PI2},{4.2,-1.5,PI2-0.2},{-3.2,-4.0,PI},{-3.2,-1.0,PI2},{-4.1,1.6,2.2*PI4},
...
double_t landmarks_pose[N_GOALS][3] = {{1.0,-0.0,-0.9849},{2.0,-3.0,0.01},{3.8,-5.5,-PI2},{1.98,-8.18,-3*PI4},{3.8,-5.5,PI2},{3.8,-4.0,PI2},{5.0,-0.0,PI2},{-3.2,-4.0,PI},{-3.2,-1.0,PI2},{-5.45,2.8,0},
                                       {-3.2,-1.0,-PI2},{-3.2,-4.0,PI},{-8.5,-4.0,PI},{-13.2,-5.8,PI2},{-11.0,-6.0,PI2},{-13.0,-2.5,PI2},{-11.8,1.2,PI2},{-11.8,6.6,PI2},{-12.8,6.6,PI},{-16.0,6.8,3*PI4},
                                       {-12.8,6.6,0.01},{-10.8,6.6,0.01},{-8.7,9.2,3*PI4},{-10.8,6.6,PI},{-12.8,9.7,PI},{-16.2,11.2,PI},{-12.8,9.7,0.01},{-10.8,12.0,0.01},
                                       {-7.2,13.1,PI}};
...
int main(int argc, char** argv)
{
  ...
  while(counter<N_GOALS)
  {
      ...
      if((counter==1)||(counter==15)){// moving human
          ...
          if(counter==1){
              if((flag)||(next_goal.target_pose.pose.position.x<2.0)){//2.0
                subgoal_flag = false;
